...
const Home = () => {
  ...
  return (
    <div>
          ...
          <div className="backdrop-blur-base bg-white/10 border border-white/20 shadow-xl rounded-lg p-8 md:p-12 text-white max-w-4xl">
            ...
            <div className="flex gap-4 mt-10">
              <button
                ...
                className="bg-[#3A7750] hover:bg-[#2f6644] text-white px-10 py-4 rounded-md text-xl font-semibold transition-all"
              >
                Get Started
              </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-center">
            <div>
              ...
              <p className="text-gray-700 text-xl leading-relaxed mb-16">
                Tap into the future of EV charging with Evant’s{" "}
                <span className="font-semibold">Find Station</span>
                gives you real-time station data, smart routing, and a
                frictionless charging experience right at your fingertips.
                Easily{" "}
                <span className="font-semibold">book charging slots</span> for
                unit and/or fleet vehicles and stay powered without the wait.
              </p>
              ...
              >
                ...
                <div className="space-y-5">
                  <div className="flex items-center">
                    <label className="w-32 text-gray-800 font-medium text-sm mb-1">
                      Vehicle data
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-800 font-medium text-sm mb-2">
                      ...
                      <span className="text-gray-800 text-[10px]">
                        Available time slots are shown in green. Unavailable
                        slots are grayed out.
                      </span>
                    </label>
      ...
      <section className="w-full bg-[#104D34] py-12 md:py-20 mt-20 mb-50">
        <div
          className="max-w-[1500px] mx-auto flex flex-col md:flex-row items-center 
  ...
  "
          ...
          <div
            className="w-full md:w-[64%] text-white text-center 
                    space-y-4 md:space-y-6 mx-auto"
          >
            <h2
              className="text-[24px] md:text-[40px] lg:text-[44px] 
            ...
            <p
              className="text-[32px] md:text-[28px] leading-relaxed opacity-90 
                    max-w-[850px] mx-auto"
            >
