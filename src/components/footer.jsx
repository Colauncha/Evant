...
function Footer() {
  return (
    <footer className="bg-[#258B59] text-white pt-32 pb-24 md:pb-48 px-4 md:px-28">
      <div className="max-w-screen-2xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-24 gap-y-8 md:gap-y-32">
          {/* LEFT — Logo + Address */}
          ...
          <div className="lg:col-span-6 mt-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
              {/* BASICS */}
              <div>
                <h4 className="font-normal text-base mb-4 text-white">
                  BASICS
                </h4>
